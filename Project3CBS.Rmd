...
- [x]  Complete the [SARTools Tutorial](2-SARTools.md) using DESeq2 differential expression analysis (SARTools (analysis without batch) and SARTools1(analysis with batch and between gene and transcript) are located in my personal repository)
- [x]  Repeat the SARTools analysis incorporating batch correction
- [x]  Compare the results of the SARTools analysis at the gene and transcript level
