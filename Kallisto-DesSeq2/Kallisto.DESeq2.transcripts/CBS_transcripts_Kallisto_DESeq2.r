...
workDir <- "/Users/Sussman/Documents/RNASeqProject/Kallisto-DesSeq2/Kallisto.DESeq2.transcripts"      # working directory for the R session

projectName <- "Kallisto.DESeq2.transcripts"                         # name of the project
author <- "Chad Sussman"                                # author of the statistical analysis/report
