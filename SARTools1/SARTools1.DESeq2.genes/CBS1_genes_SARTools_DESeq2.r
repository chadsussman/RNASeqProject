...
workDir <- "/Users/Sussman/Documents/Git/SARTools1/SARTools1.DESeq2.genes"      # working directory for the R session

projectName <- "SARTools1.DESeq2.genes"                         # name of the project
