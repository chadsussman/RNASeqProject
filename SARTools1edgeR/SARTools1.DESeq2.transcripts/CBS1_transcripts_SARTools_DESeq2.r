...
workDir <- "/Users/Sussman/Documents/Git/SARTools1/SARTools1.DESeq2.transcripts"      # working directory for the R session

projectName <- "SARTools1.DESeq2.transcripts"                         # name of the project
