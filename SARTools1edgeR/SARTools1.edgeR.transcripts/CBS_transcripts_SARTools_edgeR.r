...
workDir <- "/Users/Sussman/Documents/Git/SARTools1edgeR/SARTools1.edgeR.transcripts"      # working directory for the R session

projectName <- "SARTools1.edgeR.transcripts"                         # name of the project
